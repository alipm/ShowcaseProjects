...
public class SuperEditText extends AppCompatEditText {
    ...
    private void init(Context context, AttributeSet attrs)
    {
        ...
        Drawable icon1 = Utils.getIcon(context, R.drawable.ic_delete_button, Color.GRAY);
        ic_left_click = icon1;
        ...
        Drawable icon2 = Utils.getIcon(context, R.drawable.ic_delete_button, Color.DKGRAY);
        ic_left_unclick = icon2;
        ic_left_unclick.setBounds(left_x, left_y, left_width, left_height);
        ic_deleteResID = typedArray.getResourceId(R.styleable.SuperEditText_ic_delete, R.drawable.ic_delete_button);
        ...
        int lineColorClick_default = context.getResources().getColor(R.color.colorPrimaryDark); // 默认 = 蓝色#1296db
        int lineColorunClick_default = context.getResources().getColor(R.color.colorPrimary); // 默认 = 灰色#9b9b9b
    ...
    {
        setCompoundDrawables(leftVisible ? ic_left_click : ic_left_unclick, null, deleteVisible ? ic_delete : null, null);
